...
```bash
npm install unicode-5.0.0 --save
```
...
require('unicode-5.0.0/categories')[ codePoint ]; // lookup array
...
require('unicode-5.0.0/bidi')[ codePoint ]; // lookup array

require('unicode-5.0.0/bidi/BN/code-points');
require('unicode-5.0.0/bidi/BN/symbols');
require('unicode-5.0.0/bidi/BN/regex');

require('unicode-5.0.0/bidi/S/code-points');
require('unicode-5.0.0/bidi/S/symbols');
require('unicode-5.0.0/bidi/S/regex');

require('unicode-5.0.0/bidi/B/code-points');
require('unicode-5.0.0/bidi/B/symbols');
require('unicode-5.0.0/bidi/B/regex');

require('unicode-5.0.0/bidi/WS/code-points');
require('unicode-5.0.0/bidi/WS/symbols');
require('unicode-5.0.0/bidi/WS/regex');

require('unicode-5.0.0/bidi/ON/code-points');
require('unicode-5.0.0/bidi/ON/symbols');
require('unicode-5.0.0/bidi/ON/regex');

require('unicode-5.0.0/bidi/ET/code-points');
require('unicode-5.0.0/bidi/ET/symbols');
require('unicode-5.0.0/bidi/ET/regex');

require('unicode-5.0.0/bidi/ES/code-points');
require('unicode-5.0.0/bidi/ES/symbols');
require('unicode-5.0.0/bidi/ES/regex');

require('unicode-5.0.0/bidi/CS/code-points');
require('unicode-5.0.0/bidi/CS/symbols');
require('unicode-5.0.0/bidi/CS/regex');

require('unicode-5.0.0/bidi/EN/code-points');
require('unicode-5.0.0/bidi/EN/symbols');
require('unicode-5.0.0/bidi/EN/regex');

require('unicode-5.0.0/bidi/L/code-points');
require('unicode-5.0.0/bidi/L/symbols');
require('unicode-5.0.0/bidi/L/regex');

require('unicode-5.0.0/bidi/NSM/code-points');
require('unicode-5.0.0/bidi/NSM/symbols');
require('unicode-5.0.0/bidi/NSM/regex');

require('unicode-5.0.0/bidi/R/code-points');
require('unicode-5.0.0/bidi/R/symbols');
require('unicode-5.0.0/bidi/R/regex');

require('unicode-5.0.0/bidi/AL/code-points');
require('unicode-5.0.0/bidi/AL/symbols');
require('unicode-5.0.0/bidi/AL/regex');

require('unicode-5.0.0/bidi/AN/code-points');
require('unicode-5.0.0/bidi/AN/symbols');
require('unicode-5.0.0/bidi/AN/regex');

require('unicode-5.0.0/bidi/LRE/code-points');
require('unicode-5.0.0/bidi/LRE/symbols');
require('unicode-5.0.0/bidi/LRE/regex');

require('unicode-5.0.0/bidi/RLE/code-points');
require('unicode-5.0.0/bidi/RLE/symbols');
require('unicode-5.0.0/bidi/RLE/regex');

require('unicode-5.0.0/bidi/PDF/code-points');
require('unicode-5.0.0/bidi/PDF/symbols');
require('unicode-5.0.0/bidi/PDF/regex');

require('unicode-5.0.0/bidi/LRO/code-points');
require('unicode-5.0.0/bidi/LRO/symbols');
require('unicode-5.0.0/bidi/LRO/regex');

require('unicode-5.0.0/bidi/RLO/code-points');
require('unicode-5.0.0/bidi/RLO/symbols');
require('unicode-5.0.0/bidi/RLO/regex');
...
require('unicode-5.0.0/case-folding/C/code-points'); // lookup table with code point to code point mappings
require('unicode-5.0.0/case-folding/C/code-points')[ codePoint ]; // lookup table
require('unicode-5.0.0/case-folding/C/symbols'); // lookup table with symbol to symbol mappings
require('unicode-5.0.0/case-folding/C/symbols')[ symbol ]; // lookup table

require('unicode-5.0.0/case-folding/T/code-points'); // lookup table with code point to code point mappings
require('unicode-5.0.0/case-folding/T/code-points')[ codePoint ]; // lookup table
require('unicode-5.0.0/case-folding/T/symbols'); // lookup table with symbol to symbol mappings
require('unicode-5.0.0/case-folding/T/symbols')[ symbol ]; // lookup table

require('unicode-5.0.0/case-folding/F/code-points'); // lookup table with code point to code point mappings
require('unicode-5.0.0/case-folding/F/code-points')[ codePoint ]; // lookup table
require('unicode-5.0.0/case-folding/F/symbols'); // lookup table with symbol to symbol mappings
require('unicode-5.0.0/case-folding/F/symbols')[ symbol ]; // lookup table

require('unicode-5.0.0/case-folding/S/code-points'); // lookup table with code point to code point mappings
require('unicode-5.0.0/case-folding/S/code-points')[ codePoint ]; // lookup table
require('unicode-5.0.0/case-folding/S/symbols'); // lookup table with symbol to symbol mappings
require('unicode-5.0.0/case-folding/S/symbols')[ symbol ]; // lookup table
...
require('unicode-5.0.0/bidi-mirroring')[ codePoint ]; // lookup array
```
